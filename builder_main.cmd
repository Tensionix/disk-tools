...
title Audion Disk Tools - Builder
...
cls
echo ======================================================================
echo   AUDION DISK TOOLS - BUILDER
echo ======================================================================
echo Root: %BASE_DIR%
echo.
...
>>"%MENU_FILE%" echo [05] PEAZIP                                ^| install_peazip    ^| install portable PeaZip
>>"%MENU_FILE%" echo [06] LZ4                                   ^| install_lz4       ^| install portable LZ4 for TAR.LZ4
>>"%MENU_FILE%" echo [07] RCLONE                                ^| install_rclone    ^| install portable RClone
>>"%MENU_FILE%" echo [08] SYSTEM RCLONE                         ^| install_sys_rclone^| install user-scope system RClone
...
if /I "%RAW%"=="install_peazip" goto INSTALL_PEAZIP
if /I "%RAW%"=="install_lz4" goto INSTALL_LZ4
if /I "%RAW%"=="install_rclone" goto INSTALL_RCLONE
if /I "%RAW%"=="install_sys_rclone" goto INSTALL_SYSTEM_RCLONE
...
if /I "%RAW%"=="install_pwsh" goto INSTALL_PWSH
if /I "%RAW%"=="05" goto INSTALL_PEAZIP
if /I "%RAW%"=="5" goto INSTALL_PEAZIP
if /I "%RAW%"=="install_peazip" goto INSTALL_PEAZIP
if /I "%RAW%"=="06" goto INSTALL_LZ4
if /I "%RAW%"=="6" goto INSTALL_LZ4
if /I "%RAW%"=="install_lz4" goto INSTALL_LZ4
if /I "%RAW%"=="07" goto INSTALL_RCLONE
if /I "%RAW%"=="7" goto INSTALL_RCLONE
if /I "%RAW%"=="install_rclone" goto INSTALL_RCLONE
if /I "%RAW%"=="08" goto INSTALL_SYSTEM_RCLONE
if /I "%RAW%"=="8" goto INSTALL_SYSTEM_RCLONE
if /I "%RAW%"=="install_sys_rclone" goto INSTALL_SYSTEM_RCLONE
...
:INSTALL_PEAZIP
call "%BASE_DIR%\install\Install-Portable-PeaZip.cmd"
goto MAIN

:INSTALL_LZ4
call "%BASE_DIR%\install\Install-Portable-LZ4.cmd"
goto MAIN

:INSTALL_RCLONE
call "%BASE_DIR%\install\Install-Portable-Rclone.cmd"
goto MAIN

:INSTALL_SYSTEM_RCLONE
call "%BASE_DIR%\install\Install-System-Rclone.cmd"
goto MAIN
