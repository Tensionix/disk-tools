...
**Version 5.4.1** · 2026-09-25 · 98.2 MB

- [Direct download](https://dl.audion.dev/disk-tools/5.4.1/Audion_Disk_Tools_v5.4.1_Full.zip) — unmetered, no rate limits
- [Project page](https://audion.dev/downloads/disk-tools) — every version and how to install
- [GitHub release](https://github.com/Tensionix/disk-tools/releases/tag/v5.4.1)

<p align="center"><img src="docs/screenshot.png" alt="The program window" width="560"></p>

`SHA-256: b49a649375abcd38b5989333ada8b670ad14f3a15ae4e9b46e233ab6de708d57`
