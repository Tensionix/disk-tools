...
- [GUI ROOT-команды](#gui-root-команды)
  - [ПАПКА В ПАПКУ](#папка-в-папку)
  - [Маски](#маски)
  - [Сохранённые профили](#сохранённые-профили)
  - [Архивация](#архивация)
  - [ТРАНСФЕР ДАННЫХ](#трансфер-данных)
...
- [CLI subcommands](#cli-subcommands)
  ...
  - [manifest](#manifest)
  - [verify](#verify)
  - [compare, sync, backup](#compare-sync-backup)
  - [sync2](#sync2)
- [Кэш и pin/delete конструкторы](#кэш-и-pindelete-конструкторы)
- [Tooltip](#tooltip)
