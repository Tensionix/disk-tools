...
title Audion Media Tools - Install Portable 7-Zip
...
set "SEVENZIP_DIR=%ROOT%\Tools\7zip"
set "SEVENZIP_BIN=%ROOT%\Tools\7zip\bin"
...
echo ======================================================================
echo   AUDION MEDIA TOOLS - INSTALL PORTABLE 7-ZIP
echo ======================================================================
echo Root:    %ROOT%
...
"%PS_EXE%" -NoLogo -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$headers=@{'User-Agent'='Audion-Media-Tools'}; if($env:GITHUB_TOKEN){$headers['Authorization']='Bearer '+$env:GITHUB_TOKEN};" ^
